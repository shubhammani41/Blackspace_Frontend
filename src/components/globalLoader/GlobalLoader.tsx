        ...
        props?.static ?
            <div className={`${styles.loader_container}`}>
                <div ref={(el) => (loaderRef.current = el)} className={`${styles.loader_wrapper} ${styles.drop_down}`}
                    ...
                    <Skeleton className={`${styles.loader_skeleton}`} variant='rectangular' animation='wave' style={{ background: currentTheme.data.theme.palette?.background?.paper }}></Skeleton>
