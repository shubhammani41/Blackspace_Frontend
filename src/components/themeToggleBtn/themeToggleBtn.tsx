            ...
            <div className='df jc ac btnContainer'>
                <svg className='toggleImg' version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#000000">
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <g>
                            <path fill={(currentTheme.data.theme.palette?.secondary as SimplePaletteColorOptions).main} d="M394.658,341.342c0,17.656-14.312,32-32,32c-17.672,0-31.999-14.344-31.999-32 c0-17.687,14.327-31.999,31.999-31.999C380.346,309.343,394.658,323.655,394.658,341.342z"></path>
                            <path fill={(currentTheme.data.theme.palette?.secondary as SimplePaletteColorOptions).main} d="M266.66,106.666c0,17.68-14.32,32-32,32c-17.671,0-31.999-14.32-31.999-32 c0-17.671,14.328-31.999,31.999-31.999C252.34,74.667,266.66,88.995,266.66,106.666z"></path>
